...
public class GM_TableTest extends Contract {
    ...
    @Deprecated
    public static GM_TableTest load(
            String contractAddress,
            Web3j web3j,
            Credentials credentials,
            BigInteger gasPrice,
            BigInteger gasLimit) {
        return new GM_TableTest(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }
    ...
    public static GM_TableTest load(
            ...
            BigInteger gasPrice,
            BigInteger gasLimit) {
        return new GM_TableTest(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }
    ...
    public static GM_TableTest load(
            ...
            Credentials credentials,
            ContractGasProvider contractGasProvider) {
        return new GM_TableTest(contractAddress, web3j, credentials, contractGasProvider);
    }
    ...
    public static GM_TableTest load(
            ...
            TransactionManager transactionManager,
            ContractGasProvider contractGasProvider) {
        return new GM_TableTest(contractAddress, web3j, transactionManager, contractGasProvider);
    }

    public static RemoteCall<GM_TableTest> deploy(
            Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(
                GM_TableTest.class, web3j, credentials, contractGasProvider, BINARY, "");
    }
    ...
    public static RemoteCall<GM_TableTest> deploy(
        ...
        return deployRemoteCall(
                GM_TableTest.class, web3j, credentials, gasPrice, gasLimit, BINARY, "");
    }
    ...
    public static RemoteCall<GM_TableTest> deploy(
            ...
            ContractGasProvider contractGasProvider) {
        return deployRemoteCall(
                GM_TableTest.class, web3j, transactionManager, contractGasProvider, BINARY, "");
    }
    ...
    public static RemoteCall<GM_TableTest> deploy(
            ...
            BigInteger gasLimit) {
        return deployRemoteCall(
                GM_TableTest.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, "");
    }
