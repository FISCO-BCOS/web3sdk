	...
	public void onResponse(TransactionReceipt receipt) {
		...
		try {
			...
			if (callBackType.compareTo("transferRevert") == 0) {
				String info = "[RevertTest-TxSent]" + "\t[TxHash]=" + receipt.getTransactionHash() + "\t[From]="
						+ fromUser.getUser() + "\t[FromBalance]=" + fromUser.getAmount() + "\t[To]=" + toUser.getUser()
						+ "\t[ToBalance]=" + toUser.getAmount() + "\t[Status]=" + receipt.getStatus();
