...
public class BasicTest extends TestBase {
    ...
    public void  pbftViewTest() throws Exception {
        ...
        assertNotNull(web3j.ethPbftView().send().getEthPbftView());
    }
    ...
    public void getTransactionByBlockNumberAndIndexTest() throws IOException {
       Transaction transaction =  web3j.ethGetTransactionByBlockNumberAndIndex(DefaultBlockParameter.valueOf(new BigInteger("0")),new BigInteger("0")).send().getTransaction().get();
        assertTrue(transaction.getBlockNumber().intValue()==0);
    }
