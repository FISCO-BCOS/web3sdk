...
public class TransactionDecoderTest {
  ...
  public void testDecodingSigned() throws Exception {
    ...
    BigInteger blockLimit = new BigInteger("501");
    RawTransaction rawTransaction =
        RawTransaction.createEtherTransaction(randomid, gasPrice, gasLimit, blockLimit, to, value);
    byte[] signedMessage = TransactionEncoder.signMessage(rawTransaction, SampleKeys.CREDENTIALS);
