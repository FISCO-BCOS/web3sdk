...
public class PerformanceOKCollector {

    private static Logger logger = LoggerFactory.getLogger(PerformanceOKCollector.class);

    private Integer total = 0;

    public PerformanceOKCollector() {}
    ...
    public void onMessage(EthereumResponse response, Long cost) {
        try {
