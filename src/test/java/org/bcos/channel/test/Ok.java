...
//    }
//
//    public TransactionReceipt trans(Uint256 num) throws IOException, TransactionException {
//        Function function = new Function("trans", Arrays.<Type>asList(num), Collections.<TypeReference<?>>emptyList());
//        return executeTransaction(function);
//    }
//
//
//    public Uint256 get() throws IOException {
...
//    }
//
//    public static RemoteCall<Ok> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, BigInteger initialWeiValue) throws TransactionException {
