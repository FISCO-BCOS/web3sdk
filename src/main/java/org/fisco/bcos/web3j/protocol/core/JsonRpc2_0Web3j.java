...
public class JsonRpc2_0Web3j implements Web3j {
  ...
  public synchronized Request<?, BlockNumber> getBlockNumber() {
    return new Request<>("getBlockNumber", Arrays.asList(groupId), web3jService, BlockNumber.class);
  }
  ...
  public Request<?, SealerList> getSealerList() {
    return new Request<>("getSealerList", Arrays.asList(groupId), web3jService, SealerList.class);
  }
  ...
  public Request<?, NodeIDList> getNodeIDList() {
    return new Request<>("getNodeIDList", Arrays.asList(groupId), web3jService, NodeIDList.class);
  }

  @Override
  public Request<?, SystemConfig> getSystemConfigByKey(String key) {
    return new Request<>(
        "getSystemConfigByKey", Arrays.asList(groupId, key), web3jService, SystemConfig.class);
  }

  @Override
  public Request<?, SyncStatus> getSyncStatus() {
    return new Request<>("getSyncStatus", Arrays.asList(groupId), web3jService, SyncStatus.class);
  }
  ...
  public Request<?, BcosBlock> getBlockByNumber(
    ...
    return new Request<>(
        "getBlockByNumber",
        Arrays.asList(groupId, defaultBlockParameter.getValue(), returnFullTransactionObjects),
        web3jService,
        BcosBlock.class);
  }
  ...
  public Request<?, BcosTransaction> getTransactionByBlockNumberAndIndex(
    ...
    return new Request<>(
        ...
        Arrays.asList(
            groupId, defaultBlockParameter.getValue(), Numeric.encodeQuantity(transactionIndex)),
        web3jService,
        BcosTransaction.class);
  }
  ...
  public Request<?, PendingTransactions> getPendingTransaction() {
    return new Request<>(
        "getPendingTransactions", Arrays.asList(groupId), web3jService, PendingTransactions.class);
  }
  ...
  public Request<?, GroupPeers> getGroupPeers() {
    return new Request<>("getGroupPeers", Arrays.asList(groupId), web3jService, GroupPeers.class);
  }

  @Override
  public Request<?, BcosFilter> newPendingTransactionFilter() {
    return new Request<>(
        "newPendingTransactionFilter", Arrays.asList(groupId), web3jService, BcosFilter.class);
  }

  @Override
  public Request<?, BcosFilter> newBlockFilter() {
    return new Request<>("newBlockFilter", Arrays.asList(groupId), web3jService, BcosFilter.class);
  }
  ...
  public Flowable<NewHeadsNotification> newHeadsNotifications() {
    return web3jService.subscribe(
        new Request<>(
            "subscribe", Collections.singletonList("newHeads"), web3jService, BcosSubscribe.class),
        "unsubscribe",
  ...
  public Flowable<LogNotification> logsNotifications(List<String> addresses, List<String> topics) {
    ...
    return web3jService.subscribe(
        new Request<>(
            "subscribe", Arrays.asList(groupId, "logs", params), web3jService, BcosSubscribe.class),
        "unsubscribe",
  ...
  public Flowable<BcosBlock> replayPastBlocksFlowable(
      ...
      boolean fullTransactionObjects,
      boolean ascending) {
    return web3jRx.replayBlocksFlowable(startBlock, endBlock, fullTransactionObjects, ascending);
  }
  ...
  public Flowable<BcosBlock> replayPastBlocksFlowable(
    ...
    return web3jRx.replayPastBlocksFlowable(startBlock, fullTransactionObjects, onCompleteFlowable);
  }
  ...
  public Flowable<BcosBlock> replayPastAndFutureBlocksFlowable(
      DefaultBlockParameter startBlock, boolean fullTransactionObjects) {
    return web3jRx.replayPastAndFutureBlocksFlowable(startBlock, fullTransactionObjects, blockTime);
  }
