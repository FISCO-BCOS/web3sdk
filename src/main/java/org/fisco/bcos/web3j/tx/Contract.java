...
public abstract class Contract extends ManagedTransaction {
   ...
   * "https://github.com/ethereum/wiki/wiki/JSON-RPC#eth_getcode">eth_getCode</a> method to get the
   ...
   * initial creation will be provided, e.g. via a <em>deploy</em> method. This will not persist for
   * Contracts instances constructed via a <em>load</em> method.
   *
