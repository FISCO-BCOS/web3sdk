...
public class AMOPVerifyUtil {
    ...
    private ConcurrentHashMap<String, PrivateKey> topic2PrivateKey = new ConcurrentHashMap<String, PrivateKey>();
    private ConcurrentHashMap<String, List<PublicKey>> topic2PublicKey = new ConcurrentHashMap<String, List<PublicKey>>();
    private ECDSAUtil ecdsaUtil = new ECDSAUtil();
	...
	try {
		...
		throw new AmopException("private key of topic:" + topic + " not exist please check");
	    }
