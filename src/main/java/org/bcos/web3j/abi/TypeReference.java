 ...
 * This is so that we can pass around Typed {@link org.bcos.web3j.abi.datatypes.Array} types.
 *
 ...
 */
public abstract class TypeReference<T extends org.bcos.web3j.abi.datatypes.Type>
    ...
    public static <T extends org.bcos.web3j.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
    ...
    public abstract static class StaticArrayTypeReference<T extends org.bcos.web3j.abi.datatypes.Type>
