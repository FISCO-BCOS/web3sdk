...
public class TransactionDecoder {
    ...
    public static RawTransaction decode(String hexTransaction) {
        ...
        if (values.getValues().size() > 7) {
            ...
            return new SignedRawTransaction(randomid, gasPrice, gasLimit, blockLimit,
                to, value, data, signatureData);
        } else {
            return RawTransaction.createTransaction(randomid,
                gasPrice, gasLimit,blockLimit, to, value, data);
        }
    }
