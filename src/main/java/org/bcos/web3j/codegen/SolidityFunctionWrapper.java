...
public class SolidityFunctionWrapper extends Generator{
    ...
    private void addAddressesSupport(TypeSpec.Builder classBuilder,
        ...
        if (addresses != null) {
            ...
            // See org.bcos.web3j.tx.Contract#getStaticDeployedAddress(String)
        ...
        if (parameterSpec.type instanceof ParameterizedTypeName) {
            ...
            if (typeNames.size() != 1) {
                ...
                return "new " + parameterSpecType + "(\n"
                        + "        org.bcos.web3j.abi.Utils.typeMap("
    ...
    private void buildConstantFunction(
        ...
        if (outputParameterTypes.isEmpty()) {
            ...
            ParameterizedTypeName parameterizedTupleType = ParameterizedTypeName.get(
                    ClassName.get(
                            "org.bcos.web3j.tuples.generated",
    ...
    TypeSpec buildEventResponseObject(
            String className,
            List<org.bcos.web3j.codegen.SolidityFunctionWrapper.NamedTypeName> indexedParameters,
            List<org.bcos.web3j.codegen.SolidityFunctionWrapper.NamedTypeName> nonIndexedParameters) {

        TypeSpec.Builder builder = TypeSpec.classBuilder(className)
                .addModifiers(Modifier.PUBLIC, Modifier.STATIC);

        builder.addField(LOG, "log", Modifier.PUBLIC);
        for (org.bcos.web3j.codegen.SolidityFunctionWrapper.NamedTypeName
    ...
    private static Class<?> getStaticArrayTypeReferenceClass(String type) {
        try {
            return Class.forName("org.bcos.web3j.abi.datatypes.generated.StaticArray" + type);
